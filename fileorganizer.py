...
DIRECTORIES = {
    ...
    "ARCHIVES": [".a", ".ar", ".arh", ".tar", ".tar.bz2", ".tar.gz", ".cpio",
                 ".tar", ".gz", ".rz", ".7z", ".rar", ".xar", ".zip", ".xz",
                 ".pkg", ".deb", ".rpm"],
...
class Organize:
    def __init__(self, folder=os.getcwd(), arrangetype="e"):
        self.folder = folder
        ...
        for dir in os.scandir():
            try:
                if dir.is_dir():
                    ...
                    os.rename(os.getcwd() + '/' + str(Path(dir)), os.getcwd() +
                              '/OTHER-FILES/' + str(Path(dir)))
